...
import * as showcaseData from "./Visualizations_2021/map.json";
import MarkerClusterGroup from "react-leaflet-markercluster";
import L from 'leaflet';
import starMarker from '../showcase_2021/Visualizations_2021/asterisk-01.svg';
...
export default function Simple() {
  ...
  return (
    ...
    <Map center={[35, 0]} zoom={2} scrollWheelZoom	={false}>
       <TileLayer
