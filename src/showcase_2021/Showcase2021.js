...
import Details2020 from "../showcase_2020/Details2020.js"
import { useTranslation, Trans } from "react-i18next";
import i18next from 'i18next';
import TestCard from "../global_components/TestCard.js";
import { Bar } from 'react-chartjs-2';
import P5Wrapper from 'react-p5-wrapper';
import sketch2021 from './sketch2021.js'
import Simple from './simple2021';
import GraphButton from '../global_components/GraphButton';
import GalleryTwentyOne from './GalleryTwentyOne.js';
    ...
    <HashRouter basename='/'>
      <Switch>
        <Analytics id="UA-175461618-2" debug>
          <Route exact path="/showcase2021" children={<Gallerytwenty />} />
          <Route exact path="/showcase2021/archive" children={<Archive />} />
    ...
    <div className="body">
      ...
      <div className="twentyviz" id="twentyviz">
        ...
        <div id="viz3" className="column">
          ...
          <h1>
            <Link to="showcase2021/2021-All">{t('Viz4')}</Link>
          </h1>
        </div>
      </div>
    </div>
