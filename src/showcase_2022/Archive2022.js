          ...
          <div className = "flex">
            <div className ="column">
              <div id= "archive2021">
                ...
                <h3><i>Curated by Katie Chan</i></h3>
                <Link to="/showcase2021" className="view" onClick={() => onShowcase2021Click()}>View</Link>
            ...
            <div className ="column">
              <div id= "archive2020">
                ...
                <Link to="/showcase2020" className="view" onClick={() => onShowcase2020Click()}>View</Link>
                <a href='https://medium.com/processing-foundation/increasing-the-organization-and-scope-of-the-p5-js-showcase-7193ef558c5a' target="blank"><button className = "readmore">Read More</button></a>
              </div>
            </div>
          </div>
