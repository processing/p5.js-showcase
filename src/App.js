...
export default function App() {
  ...
  if (navigationPath.includes("showcase2020")) {
    navigation = <div className="navigation">
      <div className="menu">
        <div className="left">
          <Link to="/showcase2020" className="item">Foreword</Link>
          <Link to="/showcase2020/2020-All" className="item">Gallery</Link>
          <Link to="/showcase2020/2019" className="item">2019</Link>
          <Link to="/showcase2020/about" className="item">About</Link>
          <a href="https://p5js.org" className="item">p5.js</a>
          <a href="/" className="item" onClick={() => changeLanguage('en')}>2022 Showcase</a>
        </div>
        <div className="right">
          <button onClick={() => changeLanguage('en_showcase_2020')}>English</button>
          <button onClick={() => changeLanguage('es_showcase_2020')}>Español</button>
          <button onClick={() => changeLanguage('zh_Hans_showcase_2020')}>简体中文</button>
          <button onClick={() => changeLanguage('ko_showcase_2020')}>한국어</button>
        </div>
      </div>
    ...
    navigation = <div className="navigation">
      <div className="menu">
        <div className="left">
          <Link to="/showcase2021" className="item">Foreword</Link>
          <Link to="/showcase2021/2021-All" className="item">Gallery</Link>
          <Link to="/showcase2021/archive" className="item">Archive</Link>
          <Link to="/showcase2021/about" className="item">About</Link>
          <a href="https://p5js.org" className="item">p5.js</a>
          <a href="/" className="item" onClick={() => changeLanguage('en')}>Back to 2022 Showcase</a>
        </div>
        <div className="right">
          <button onClick={() => changeLanguage('en_showcase_2021')}>English</button>
          <button onClick={() => changeLanguage('es_showcase_2021')}>Español</button>
          <button onClick={() => changeLanguage('zh_Hans_showcase_2021')}>简体中文</button>
          <button onClick={() => changeLanguage('ko_showcase_2021')}>한국어</button>
        </div>
      </div>
      <div className="nav-text">
        <p>You are currently viewing the 2021 Showcase</p>
    ...
    navigation = <div className="navigation">
      <div className="menu">
        <div className="left">
          ...
          <Link to="/2022-All" className="item">Gallery</Link>
    ...
    <HashRouter basename='/'>
      ...
      <Switch>
        <Analytics id="UA-175461618-2" debug>
          ...
          <Route exact path="/showcase2021/archive" children={<Archive2021 />} />
          <Route exact path="/showcase2021/2021-:filter/" children={<GalleryTwentyOne />} />
          <Route exact path="/showcase2021/2021-:filter/:id" children={<Detailed2020Page />} />
          ...
          <Route exact path="/2022-:filter/:id" children={<Detailed2022Page />} />
